...
pixi add pixi-build-rattler-build
# for installing globally
pixi global install pixi-build-rattler-build
```
...
It is possible to list all of the versions of `pixi-build-rattler-build` available on your platform:
...
```
pixi search pixi-build-rattler-build --channel conda-forge
```
